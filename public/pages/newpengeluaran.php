...
if (isset($_POST['save'])) {
    ...
    if ($createstatus) {
        $pesan = "Pengeluaran berhasil ditambah";
        $session->pesan($pesan);
...
<main role="main" class="container">
    ...
    <div class="row">
        <div class="col-lg">
            <h2 class="my-4">Tambah Pengeluaran Baru</h2>
            <form action="newpengeluaran.php" method="POST">
                <div class="form-group">
                    <label>Jumlah Rupiah</label>
                    <input type="number" class="form-control" min="0" step="1" placeholder="5000" name="rupiah_keluar" required>
                </div>
                <div class="form-group">
